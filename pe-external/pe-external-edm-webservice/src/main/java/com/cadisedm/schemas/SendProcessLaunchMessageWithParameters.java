 ...
 *         &lt;element name="configurableParameters" type="{http://schemas.microsoft.com/2003/10/Serialization/Arrays}ArrayOfKeyValueOfstringstring" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "SendProcessLaunchMessageWithParameters")
public class SendProcessLaunchMessageWithParameters {
    ...
    @XmlElementRef(name = "configurableParameters", namespace = "http://www.cadisedm.com/Schemas/", type = JAXBElement.class)
    protected JAXBElement<com.microsoft.schemas._2003._10.serialization.arrays.ArrayOfKeyValueOfstringstring> configurableParameters;
    ...
    /**
     * Gets the value of the configurableParameters property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<ArrayOfKeyValueOfstringstring> getConfigurableParameters() {
        return configurableParameters;
    }

    /**
     * Sets the value of the configurableParameters property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfKeyValueOfstringstring }{@code >}
     *     
     */
    public void setConfigurableParameters(JAXBElement<ArrayOfKeyValueOfstringstring> value) {
        this.configurableParameters = ((JAXBElement<ArrayOfKeyValueOfstringstring> ) value);
    }
